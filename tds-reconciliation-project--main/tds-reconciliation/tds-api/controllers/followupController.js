...
export const updateFollowup = async (req, res) => {
  try {
    ...
    if (tanNo !== undefined) { updates.push('tan_no = ?'); params.push(String(tanNo).toUpperCase().trim()); }
    if (companyName !== undefined) { updates.push('company_name = ?'); params.push(String(companyName).trim()); }
